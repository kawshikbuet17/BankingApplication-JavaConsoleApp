...
public class CurrentAccount implements Account {
    ...
    private static final double ACCOUNT_CLOSING_CHARGE = 10.0;
    ...
    public CurrentAccount(String accountName, String accountNumber, Date creationDate, double initialBalance) throws InsufficientInitialDepositException {
