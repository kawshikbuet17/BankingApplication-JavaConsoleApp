...
public class SavingsAccount implements Account {
    ...
    private static final double ACCOUNT_CLOSING_CHARGE = 5.0;
    private static final double YEARLY_INTEREST_RATE = 0.02;
    ...
    public SavingsAccount(String accountName, String accountNumber, Date creationDate, double initialBalance) throws InsufficientInitialDepositException {
    ...
    public double calculateInterest(){
        return balance * YEARLY_INTEREST_RATE;
    }
